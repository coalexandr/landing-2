            ...
            <div className="team-grid">
              <Reveal className="team-card">
                ...
                <div className="team-actions">
                  ...
                  <a href={`https://wa.me/${WHATSAPP_NUMBERS.alex}`} target="_blank" rel="noreferrer" className="btn btn-whatsapp btn-sm">
              ...
              <Reveal className="team-card" style={{ transitionDelay: '90ms' }}>
                ...
                <div className="team-actions">
                  ...
                  <a href={`https://wa.me/${WHATSAPP_NUMBERS.stan}`} target="_blank" rel="noreferrer" className="btn btn-whatsapp btn-sm">
                    <MessageCircle size={14} /> {t.team.btnWhatsAppDirect}
                  </a>
                </div>
              </Reveal>
